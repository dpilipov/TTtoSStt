...
#rootfile_path = '{}/store/user/dpilipov/topHBoostedAllHad/snapshot'.format(redirector)
rootfile_path = '{}/uscms/home/dpilipov/nobackup/TIMBER/CMSSW_11_1_4/src/TTtoSStt'.format(redirector)
...
signal_names = ['THsnapshot_StoAA_16_1of1']
names = {'StoAA': "b*_{LH} 2000 (GeV)"}
colors = {'StoAA': ROOT.kBlue}
