...
#        self.a.Define('SidsAA','PickDiphotons(Photon_pt,Photon_eta,Photon_phi,Photon_mass,200.0)')
        ...
        self.a.Define('Apt1','AA_vector[4]')
        self.a.Define('Aeta0','AA_vector[1]')
        self.a.Define('Aeta1','AA_vector[5]')
        self.a.Define('Aphi0','AA_vector[2]')
        self.a.Define('Aphi1','AA_vector[6]')
        self.a.Define('Amass0','AA_vector[3]')
